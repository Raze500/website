...
function greenTheme() {
    console.log("Switching to green theme");
    $("#greenTheme").prop("checked", true);
    $("body").addClass("green");
    $(".music-player").removeClass("amber-theme").addClass("green-theme");
    createCookie('greenTheme', 1);
}

function amberTheme() {
    console.log("Switching to amber theme");
    $("#greenTheme").prop("checked", false);
    $("body").removeClass("green");
    $(".music-player").removeClass("green-theme").addClass("amber-theme");
    createCookie('greenTheme', 0);
}

function toggleTheme() {
    if ($("#greenTheme").is(":checked")) {
        console.log("Amber theme active, switching to green");
        amberTheme();
    } else {
        console.log("Green theme active, switching to amber");
        greenTheme();
    }
}
...
// Reproductor de audio y controles personalizados
